...
Route::redirect("/", "/Home")->name("root.redirect");
Route::group(["prefix" => "Home", "middleware" => ["checkLogin"]], function () {
    ...
    Route::get("/customer/info", [CustomerController::class, "indexInfoCustomer"])->name("customer.info");
    Route::post("/customer/info/{id}", [CustomerController::class, "updateInfoCustomer"])->name("customer.update");
